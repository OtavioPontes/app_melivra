...
class _ClearExplanationWidgetState extends State<ClearExplanationWidget> {
  ...
  @override
  void initState() {
    value = controller.clearExplanationValue.toDouble();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    final barColor =
        UtilsScoreEnum.getEnumFromScore(score: value.toInt()).getColor;
                      ...
                      onChanged: (value) {
                        if (value.isNotEmpty) {
                          setState(() {
                            ...
                            controller.clearExplanationValue = int.parse(value);
                          });
                        }
                      },
                      maxLength: 3,
